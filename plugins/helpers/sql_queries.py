class SqlQueries:
    songplay_table_insert = ("""
        ...
        SELECT
                ...
                events.location, 
                events.useragent
            FROM (SELECT TIMESTAMP 'epoch' + ts/1000 * interval '1 second' AS start_time, * FROM staging_events WHERE page='NextSong') AS events
        ...
        FROM songplays_staging
            LEFT JOIN songplays
                ON songplays_staging.playid = songplays.playid
